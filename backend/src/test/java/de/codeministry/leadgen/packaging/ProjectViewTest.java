...
class ProjectViewTest {
    ...
    void aClosedPeriodReadsTheSameInBothLanguages() {
        ...
        assertThat(ProjectView.period(YearMonth.of(2020, 9), YearMonth.of(2023, 7), "de"))
                .isEqualTo(expected);
        assertThat(ProjectView.period(YearMonth.of(2020, 9), YearMonth.of(2023, 7), "en"))
                .isEqualTo(expected);
    }
    ...
    void aMissingTitleFallsBackToTheOtherLanguageInBothDirections() {
        ...
        assertThat(ProjectView.of(project("Plattform", null, "Satz.", null), "en")
                        .title())
                .isEqualTo("Plattform");
        assertThat(ProjectView.of(project(null, "Platform", null, "Sentence."), "de")
                        .title())
                .isEqualTo("Platform");
    }
    ...
    void thePitchFallsBackInBothDirectionsToo() {
        ...
        assertThat(ProjectView.of(project("Plattform", "Platform", null, "Sentence."), "de")
                        .pitch())
                .isEqualTo("Sentence.");
        assertThat(ProjectView.of(project("Plattform", "Platform", "Satz.", null), "en")
                        .pitch())
                .isEqualTo("Satz.");
    }
    ...
    private static SkillProfile.ReferenceProject project(
        ...
        return new SkillProfile.ReferenceProject(
                "p", titleDe, titleEn, YearMonth.of(2024, 1), null, "Fullstack", List.of("Java"), pitchDe, pitchEn);
    }
}
