...
class LlmExtractorsTest {
    ...
    void fallsBackToTheScoringModelRatherThanAskingForASecondEntry() {
        ...
        assertThat(LlmExtractors.modelFor(new Models(null, "a-judge", null, null, null))).isEqualTo("a-judge");
        assertThat(LlmExtractors.modelFor(new Models("  ", "a-judge", null, null, null))).isEqualTo("a-judge");
    }
    ...
    void namesNothingOnAFreshClone() {
        ...
        assertThat(LlmExtractors.modelFor(new Models(null, null, null, null, null))).isNull();
