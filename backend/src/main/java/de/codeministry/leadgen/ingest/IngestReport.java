 ...
 * @param fields     what reading the start, the duration and the deadline out of the adverts
 *                   did. `stated` is the share this stage is worth; `rejudged` is what it cost,
