...
describe('App', () => {
    ...
    it('asks the API for its status on init and renders it', async () => {
      ...
      httpMock.expectOne('/api/v1/status').flush({application: 'lead-generation', version: '0.4.0'});
      ...
      expect(fixture.nativeElement.textContent).toContain('lead-generation 0.4.0');
        httpMock.verify();
    });
});
